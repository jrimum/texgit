...
@XmlType(name = "MetaGroupFields", propOrder = {
    "fields",
    "idType",
    "sequencialNumber"
})
public class MetaGroupFields {
    ...
    @XmlElement(name = "SequencialNumber", required = true)
    ...
    public static class IdType
        extends JAXBElement<MetaOrderedField>
    {

        protected final static QName NAME = new QName("", "IdType");

        public IdType(MetaOrderedField value) {
            super(NAME, ((Class) MetaOrderedField.class), MetaGroupFields.class, value);
        }

    }

    public static class SequencialNumber
        extends JAXBElement<MetaOrderedField>
    {
