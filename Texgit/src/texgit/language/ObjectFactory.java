 ...
 * generated in the texgit.language package. 
...
public class ObjectFactory {
    ...
    private final static QName _Texgit_QNAME = new QName("http://gilmatryx.googlepages.com/Texgit", "Texgit");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: texgit.language
     * 
     */
    ...
    public JAXBElement<MetaTexgit> createTexgit(MetaTexgit value) {
        return new JAXBElement<MetaTexgit>(_Texgit_QNAME, MetaTexgit.class, null, value);
    }
    ...
    public MetaGroupFields.SequencialNumber createMetaGroupFieldsSequencialNumber(MetaOrderedField value) {
    ...
    public MetaGroupFields.IdType createMetaGroupFieldsIdType(MetaOrderedField value) {
